...
public class StatusBarUtil {
    ...
    public static void setImmersionStatus(BaseActivity activity, View titleBar) {
        ...
        StatusBarUtil.setBarColor(activity, activity.getResources().getColor(R.color.title_black));
    }
}
