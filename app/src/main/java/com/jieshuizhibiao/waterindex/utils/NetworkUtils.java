...
/**
 * Created by WanghongHe on 2018/11/9 11:38.
 */
...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        WaterIndexUtils.getApp().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) WaterIndexUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) WaterIndexUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) WaterIndexUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) WaterIndexUtils.getApp().getSystemService(WIFI_SERVICE);
        if (wm == null) {return "";}
