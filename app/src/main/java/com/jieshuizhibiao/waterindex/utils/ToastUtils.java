...
public class ToastUtils {
    ...
    public static void showCustomToastMsg(String message, int yOffset) {
        View layout = LayoutInflater.from(WaterIndexApplication.getInstance()).inflate(R.layout.layout_discover_toast, null);
    ...
    public static void showSuccessToast(String msg) {
        Toast toast = new Toast(WaterIndexApplication.getInstance());
        View view = View.inflate(WaterIndexApplication.getInstance(), R.layout.layout_view_toast, null);
