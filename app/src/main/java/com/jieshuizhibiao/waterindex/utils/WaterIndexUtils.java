...
/**
 * Created by WanghongHe on 2018/11/9 12:21.
 */
public final class WaterIndexUtils {
    ...
    static Context getTopActivityOrApp() {
        if (isAppForeground()) {
            ...
            return topActivity == null ? WaterIndexUtils.getApp() : topActivity;
        } else {
            return WaterIndexUtils.getApp();
        }
    }

    static boolean isAppForeground() {
        ActivityManager am = (ActivityManager) WaterIndexUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        //noinspection ConstantConditions
        List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
        if (info == null || info.size() == 0) {return false;}
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(WaterIndexUtils.getApp().getPackageName());
            }
        }
        return false;
    }
    ...
    static void restoreAdaptScreen() {
        ...
        final DisplayMetrics appDm = WaterIndexUtils.getApp().getResources().getDisplayMetrics();
    ...
    public static final class FileProvider4UtilCode extends FileProvider {
        ...
        public boolean onCreate() {
            WaterIndexUtils.init(getContext());
            return true;
        }
    }
