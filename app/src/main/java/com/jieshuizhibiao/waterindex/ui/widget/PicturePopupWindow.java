 ...
 * @ClassName: PicturePopupWindow
 * @Description: java类作用描述
 * @Author: sxt
 * @CreateDate: 2018/12/24 3:10 PM
 * @UpdateUser: 更新者
 * @UpdateDate: 2018/12/24 3:10 PM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
...
public class PicturePopupWindow extends PopupWindow {
    ...
    private void initView() {
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.module_popupwindow, null);
    ...
    boolean flag) {
        ...
        va.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (!flag) {
                    isHideAniming = false;
                    PicturePopupWindow.super.dismiss();
                } else {
                    isShowAniming = false;
                }
            }
