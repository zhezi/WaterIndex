...
public class SellerUnpayActivity extends BaseActivity implements CommonViewImpl {
    ...
    public void onClick(View view) {
        ...
        switch (id){
            ...
            case R.id.ll_card:
                ...
                break;
            case R.id.ll_alipay:
                showOrDismissImg(imgRightAlipay);
                ...
                break;
            case R.id.ll_wechat:
                showOrDismissImg(imgRightWechat);
    ...
    private void showOrDismissImg(ImageView img){
