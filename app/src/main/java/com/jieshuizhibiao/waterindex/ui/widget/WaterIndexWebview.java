package com.jieshuizhibiao.waterindex.ui.widget;
...
public class WaterIndexWebview extends WebView {
    public WaterIndexWebview(Context context) {
        super(context);
        webViewSetting();
    }

    public WaterIndexWebview(Context context, AttributeSet attrs) {
        super(context, attrs);
        webViewSetting();
    }

    public WaterIndexWebview(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        webViewSetting();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public WaterIndexWebview(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        webViewSetting();
    }

    public WaterIndexWebview(Context context, AttributeSet attrs, int defStyleAttr, boolean privateBrowsing) {
