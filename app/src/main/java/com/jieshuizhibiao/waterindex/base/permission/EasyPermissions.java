package com.jieshuizhibiao.waterindex.base.permission;
...
public class EasyPermissions {
    ...
    private static AlertChainDialog alertChainDialog;
    private  static   RationaleDialogFragmentCompat fragment;
    ...
    private static void showRationaleDialogFragmentCompat(
            ...
            @NonNull String rationale, @NonNull String positiveButton, @NonNull String negativeButton,
            final int requestCode, @NonNull final String... perms) {

        fragment = RationaleDialogFragmentCompat
    ...
    private static void showRationaleAlertDialog(
        ...
        if (alertChainDialog == null) {
            alertChainDialog = new AlertChainDialog(activity);
            alertChainDialog.setCancelable(false);
            alertChainDialog.builder()
                    .setTitle("申请权限")
                    .setMsg(rationale)
