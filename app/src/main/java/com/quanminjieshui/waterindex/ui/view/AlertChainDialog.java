package com.quanminjieshui.waterindex.ui.view;
...
public class AlertChainDialog extends Dialog {
    ...
    public AlertChainDialog builder() {
        // 获取Dialog布局
    ...
    public AlertChainDialog setTitle(String title) {
        showTitle = true;
        if ("".equals(title)) {
    ...
    public AlertChainDialog setPositiveButton(String text, final View.OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("确定");
        } else {
    ...
    public AlertChainDialog setNegativeButton(String text,final View.OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("取消");
        } else {
