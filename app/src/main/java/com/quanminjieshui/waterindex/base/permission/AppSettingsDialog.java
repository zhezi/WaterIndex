...
public class AppSettingsDialog {
    ...
    private AlertChainDialog mAlertDialog;
    ...
    private AppSettingsDialog(@NonNull final Object activityOrFragment,
        ...
        AlertChainDialog dialogBuilder = new AlertChainDialog(context).builder();

        // Set rationale
        dialogBuilder.setMsg(rationale);
        ...
        dialogBuilder.setPositiveButton(positiveButtonText, new View.OnClickListener() {
            @Override
